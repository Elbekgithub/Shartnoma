...
class StudentAddForm(UserCreationForm):
    ...
    is_contract = forms.BooleanField(label = "*is_contract", required=False)
    ...
    def save(self):
        ...
        user.email=self.cleaned_data.get('email')
        user.save()
        student = Student.objects.create(user=user, id_number=user.username, group=self.cleaned_data.get('group'),is_contract=self.cleaned_data.get('is_contract'), level=self.cleaned_data.get('level'))
        student.save()
        return user
